...
<div class=" mb-4 d-flex justify-content-end align-items-center">
                ...
                @foreach ($inventario as $item)
                    <tr>
                        ...
                        <td>
                            <form action="{{route('inventario.aumentar_cantidad' , $item->id)}}" method="POST">
                                @csrf
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                            <input type="number" name="cantidad" class="form-control" value="{{ $item->cantidad }}" min="1" max="100">
                                       </div>
                        ...
                        <td>
                            ...
                            <a href="#" class="ml-4" onclick="deleteHistoria(  '{{ $item->id }}' , '{{ route('inventario.delete' , isset($item->id) ? $item->id : '-1') }}')">
                                {!! iconos('delete') !!}
                            </a>
                        </td>
                    </tr>
    ...
    {{-- Modal CREAR --}}
    <x-modal id="modal1" title="Registrar Item">
        <div class="table-container">
            <form action="{{ route('inventario.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <button class="btn-default" type="submit">Registrar Item</button>
                </div>
            </form>
        </div>
    </x-modal>
